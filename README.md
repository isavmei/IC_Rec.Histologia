...
│
├─ CORROMPIDAS/            # Imagens corrompidas ou ilegíveis
├─ BAIXA_RES/              # Imagens com resolução abaixo do mínimo
├─ DUPLICADAS/             # Imagens duplicadas
├─ RAW_CLEANED/            # Dataset limpo
│   ├─ train/
│   │   ├─ class1/
│   │   └─ class2/
│   └─ test/
...
└─ features/               # Features extraídas
    ├─ features.csv        # CSV com todas as features
    ├─ features.npy        # Numpy array com valores numéricos
    └─ labels.npy          # Numpy array com file, classe e tipo de augment
